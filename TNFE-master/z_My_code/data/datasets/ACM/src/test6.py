...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\train_data\struct_role_neigh2.txt','wb') as f2:
    for index,line in enumerate(neigh_lines):
        if(index > 2767):    # 当前最后一行的数字-1
            struct_role_list = []
            # 去重
