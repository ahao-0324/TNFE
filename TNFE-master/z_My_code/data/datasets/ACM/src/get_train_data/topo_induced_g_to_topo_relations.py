...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\topology_induced_graph.pkl','rb') as fr:
    G = pickle.load(fr)
...
aa_number = 0
pp_number = 0
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\train_data\topo_relaiton.txt','wb') as f2:
    # G.adjacency()格式如下
    # p10584 表示节点
