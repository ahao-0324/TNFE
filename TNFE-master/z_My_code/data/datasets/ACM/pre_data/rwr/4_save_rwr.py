...
# input graph
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\topology_induced_graph.pkl', 'rb') as f:
    g = pickle.load(f)
...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\generated_data\a_neigh.npy', 'wb') as f:
    np.save(f, save_a_neigh)
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\generated_data\a_neigh_w.npy', 'wb') as f:
    ...
    for i in g[nod]:  # i:nod节点的neighbor
        for j in g[nod][i]:  # j:key relation
            ...
            #     p_a_cited_list_w.append(g[nod][i][9]['w'] * g.in_degree(i))
                ...
                p_v_published_list.append(v_node2id_dict[i])   # v名字不是顺序的，所以需转化
...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\generated_data\p_neigh.npy', 'wb') as f:
    np.save(f, save_p_neigh)
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\pre_data\rwr\generated_data\p_neigh_w.npy', 'wb') as f:
