...
def edge_weight_func(features_array):
    ...
    np.save(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\ACM\topological_neighbor_similarity_calculate\generated_data\edge_weight_mat.npy', edge_weight_mat)
