...
# p_list = []
# v_list = []
with open(r'D:\Program Files\PycharmProjects\pythonProject\bs_swu_my_classes\DBLP_pre\data\relations.txt', 'r') as f2:
    for line in f2:
        line = line.strip()
        if (line.split('\t')[2] == '0'):
...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\pre_data\rwr\dblp_graph.pkl', 'wb') as f:
    pickle.dump(g, f)
