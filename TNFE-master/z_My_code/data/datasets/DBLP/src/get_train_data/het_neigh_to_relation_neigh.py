...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\train_data\struct_role_neigh.txt','rb') as edge_file:
    neigh_lines = edge_file.readlines()

with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\train_data\relation_neigh_structrole.txt','wb') as f2:
