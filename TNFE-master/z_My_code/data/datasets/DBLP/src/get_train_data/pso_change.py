...
class package:
    ...
    def fit_func(self, x):    # 传入的x是列表，里面由0和1组成，表示所选择的节点
        ...
        with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\pre_data\rwr\dblp_graph.pkl','rb') as fr:
            G = pickle.load(fr)
        # 加载总的拓扑势列表
        total_str_role_list = np.load(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\train_data\total_str_role_list.npy',allow_pickle=True)
