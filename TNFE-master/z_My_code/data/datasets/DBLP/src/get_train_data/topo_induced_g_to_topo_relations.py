...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\pre_data\rwr\topology_induced_graph.pkl','rb') as fr:
    G = pickle.load(fr)
...
# 得到节点和id对应的字典
node2id_dict = dict()
with open(r'D:\Program Files\PycharmProjects\pythonProject\bs_swu_my_classes\DBLP_pre\data\node2id.txt', 'r') as f1:
...
aa_number = 0
pp_number = 0
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\train_data\topo_relaiton.txt','wb') as f2:
    # G.adjacency()格式如下
    # p10584 表示节点
