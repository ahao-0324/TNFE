...
import math
import z_My_code.data.datasets.DBLP.src.get_train_data.pso_change as pso
...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\DBLP\train_data\struct_role_neigh.txt','wb') as f2:
