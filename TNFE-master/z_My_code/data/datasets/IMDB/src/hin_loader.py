...
class HIN(object):
    ...
    def __init__(self, hp):
        ...
        # ================== Gen feature ==================
        dw_feat_file = r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\dw_emb_features2.npy'
        if hp.init_dw_emb:
    ...
    def get_epoch_samples(self, epoch, hp):
        ...
        def _get_neg_edge(epoch_seed):
            fname = r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\pre_data\model_data\imdb\neg_edges\NE-rate={:.0f}_seed={}.dat'.format(
        ...
        def _get_ns_instance(epoch_seed):
            ...
            if os.path.exists(fname):   # 如果网络模式文件已经存在，则直接加载该文件
                ...
                f_type_adj = r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\relation2id_localnetwork.txt'
