...
def main(hp):
    ...
    # 保存得到的嵌入
    torch.save(node_emb, r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\pre_data\model_data\imdb\final_embedding.pt')
