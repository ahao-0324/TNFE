...
def load_nodes(dataset):
    ...
    in_path = r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\node2id.txt'
...
def load_relations(in_path, dataset="dblp", node_cnt=9707):
    # ============ Generate adj_mx ============
    with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\topo_relaiton.txt') as edge_file:
    ...
    # ============ 获得rwr邻居列表，即局部网络结构 ============
    with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\relation_neigh_structrole.txt','rb') as edge_file:
