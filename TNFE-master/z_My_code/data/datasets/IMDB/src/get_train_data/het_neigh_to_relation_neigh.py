...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\struct_role_neigh.txt','rb') as edge_file:
    neigh_lines = edge_file.readlines()

with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\relation_neigh_structrole.txt','wb') as f2:
    for line in neigh_lines:
        ...
        for i in range(len(neigh_list_new)):
            if(i > 0):
                ...
                # 判断两个节点间的关系
                if(left_node[0] == 'a' and right_node[0] == 'm'):
                    relation = '0'
                if (left_node[0] == 'm' and right_node[0] == 'a'):
                    relation = '1'
                if (left_node[0] == 'm' and right_node[0] == 'd'):
                    relation = '2'
                if (left_node[0] == 'd' and right_node[0] == 'm'):
                    relation = '3'
                # 获得节点id
