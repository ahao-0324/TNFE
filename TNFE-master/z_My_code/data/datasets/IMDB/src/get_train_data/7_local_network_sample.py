...
import math
import z_My_code.data.datasets.IMDB.src.get_train_data.pso_change as pso
...
with open(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\struct_role_neigh.txt','wb') as f2:
