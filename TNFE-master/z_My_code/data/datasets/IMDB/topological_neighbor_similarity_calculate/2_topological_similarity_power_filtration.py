...
# 获得节点特征向量矩阵
features_list = np.load(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\train_data\dw_emb_features.npy')
...
# node_similarity_matrix = np.load(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\topological_neighbor_similarity_calculate\generated_data\edge_weight_mat.npy')
k_hop = 2
# # 得到每个节点的k阶邻居加权子图
...
np.save(r'D:\Program Files\PycharmProjects\pythonProject\mycode-master\z_My_code\data\datasets\IMDB\topological_neighbor_similarity_calculate\generated_data\imdb_power_filtration_wasserstein_distances.npy', wasserstein_distances)
